...
year_list = ['1998', '1999','2000', '2001', '2002',
    ...
    for year in year_list:
        ...
        for row in soup.find('div', {'id':'all_team_schedule'}).find('tbody').find_all('tr'):
            ...
            for n in boxscore:
                ...
                for row2 in soup_2.find('div', {'id':'all_TampaBayDevilRaysbatting'}).find_all('tfoot'):
                    try:
                ...
                for row3 in soup_2.find('div', {'id':'all_TampaBayDevilRayspitching'}).find_all('tfoot'):
                    try:
