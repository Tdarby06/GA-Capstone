...
year_list = ['1997', '1998', '1999','2000', '2001', '2002', '2003', '2004']
    ...
    for year in year_list:
        ...
        for row in soup.find('div', {'id':'all_team_schedule'}).find('tbody').find_all('tr'):
            ...
            for n in boxscore:
                ...
                for row2 in soup_2.find('div', {'id':'all_AnaheimAngelsbatting'}).find_all('tfoot'):
                    try:
                ...
                for row3 in soup_2.find('div', {'id':'all_AnaheimAngelspitching'}).find_all('tfoot'):
                    try:
...
df2 = pd.concat(club, sort = False)
df2.to_csv(f'./data_scrape/{team}_final.csv', index = False)
