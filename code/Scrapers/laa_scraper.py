    ...
    for year in year_list:
        ...
        for row in soup.find('div', {'id':'all_team_schedule'}).find('tbody').find_all('tr'):
            ...
            for n in boxscore:
                ...
                for row2 in soup_2.find('div', {'id':'all_LosAngelesAngelsofAnaheimbatting'}).find_all('tfoot'):
                    try:
                ...
                for row3 in soup_2.find('div', {'id':'all_LosAngelesAngelsofAnaheimpitching'}).find_all('tfoot'):
                    try:
